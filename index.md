...
**Base URL (Staging):** `https://mapi.oppay88.com/api/KYC`

**Base URL (Production):** `https://mapi.battt.io/api/KYC`
...
|---|---|---|---|
| `MerchantReferenceId` | `string` | No | Merchant's own reference ID for this request |
...
```json
{
  ...
  "data": {
    "orderId": "KYC20260317000001",
    "merchantReferenceId": "REF001",
    "scrapedBankAccountName": "กุลพันธ์",
    "scrapedBankAccountNameEN": "Kunlapan",
    "status": "Success",
    "createdAt": "2026-03-17T10:00:00.000Z",
    "updatedAt": "2026-03-17T10:01:00.000Z",
    "errorCode": null,
...
| `scrapedBankAccountName` | `string` | No | The verified account holder name returned from the bank |
| `scrapedBankAccountNameEN` | `string` | No | The verified english account holder name returned from the bank |
...
|---|---|---|---|
| `OrderId` | `string` | No | System-generated order ID (e.g. `KYC20260317000001`) |
| `MerchantReferenceId` | `string` | No | The reference ID used in the original Create request |
| `MerchantCode` | `string` | Yes | Unique merchant identifier |
...
| `scrapedBankAccountNameEN` | `string` | No | The english bank account name retrieved during reconciliation |
| `status` | `string` | No | Current status of the KYC request |
